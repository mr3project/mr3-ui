...
export default AbstractRoute.extend({
  ...
  load: function (value, query/*, options*/) {
    ...
    if(query.containerID) {
      ...
      loader = this.get("loader").queryRecord('container', query.containerID, {reload: true}).then(function (record) {
        return [record];
      },function () {
        return [];
      });
      ...
      loader = this.get("loader").query('container', query, {reload: true});
    }
