...
export default AMTimelineModel.extend({
  ...
  firstTaskStartTime: Ember.computed("am.firstTaskStartTime", function() {
    return this.get("am.firstTaskStartTime");
	}),
  lastTaskFinishTime: Ember.computed("am.lastTaskFinishTime", function() {
    return this.get("am.lastTaskFinishTime");
	}),
  ...
  killedTasks: Ember.computed("am.killedTasks", function() {
    return this.get("am.killedTasks");
	}),
  ...
  processorClass: DS.attr('string'),

  containerGroupName: DS.attr('string'),
